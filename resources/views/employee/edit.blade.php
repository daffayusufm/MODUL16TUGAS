                ...
                <form action="{{ route('employees.update', ['employee' => $employee->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            value="{{ old('firstName', $employee->firstname) }}" placeholder="Enter First Name">
                            @error('firstName')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            value="{{ old('lastName', $employee->lastname) }}" placeholder="Enter Last Name">
                            @error('lastName')
                                <div class="text-danger"><small>{{ $message }}</small></div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            value="{{ old('age', $employee->age) }}" placeholder="Enter Age">
                            @error('age')
                                <div class="text-danger"><small>{{ $message }}</small></div>
                            @enderror
                        </div>
                        ...
                        <div class="mt-4">
                            @if ($employee->original_filename)
                                ...
                                <a href="{{ route('employees.download', $employee->id) }}" class="btn btn-primary btn-sm mt-2">Download CV</a>
                                <br><br>
                            @endif
                        </div>
